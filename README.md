A react todo app with the state being on the firebase database using the redux state management + react routing library + sass preprocessor + users and user authentication + Google auth
